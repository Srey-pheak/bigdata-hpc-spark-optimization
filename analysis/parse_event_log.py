...
# ── arguments ─────────────────────────────────────────────────────────────────
file_path = sys.argv[1] if len(sys.argv) > 1 else "events_log.json"  # Change default file actually file name
...
# ── print summary ──────────────────────────────────────────────────────────────
print("\nSpark event log parsed successfully.")
print("Metrics were written to events_log_metric.csv")
print("Check the metrics file for results.\n")


# ── write CSV row ──────────────────────────────────────────────────────────────
csv_path = "/projects/F202500010HPCVLABUMINHO/uminhocp150/big_data/analysis/events_log_metric.csv"
fieldnames = [
    "run_label", "parsed_at",
    "app_duration_s",
    "driver_time_s",
